...
plot(sub_data$time , sub_data$sub_metering_1 ,type = 'n',xlab = "", ylab = "energy sub metering", main = "ENERGY SUB METERING")
...
legend("topright", lty = 10, col = c("black", "red", "blue"), legend = c("sub_metering_1", "sub_metering_2", "sub_metering_3"))
